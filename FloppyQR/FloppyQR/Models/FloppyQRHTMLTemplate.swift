...
<div id=g></div>
<script>
var M=0xDA7A10DA,A='\(appId)',ST=\(strict),L=document.getElementById('l');
...
function R(){var h=document.getElementById('g');h.innerHTML='';if(!C.length)return;
...
d.onclick=function(){location.href=URL.createObjectURL(new Blob([x.h],{type:'text/html'}))};
h.appendChild(d)})}
